...
async def handle_contact(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    reply_markup = ReplyKeyboardMarkup(MAIN_KEYBOARD, web_app=WebAppInfo(url=f'http://192.168.100.5:5173/?tg_user_id={update.effective_user.id}'), resize_keyboard=True)
